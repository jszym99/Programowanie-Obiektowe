...
//! \brief Modeluje klase prostopadloscianu o podstawie szesciokata foremnego
class Graniastoslup6 : public UkladW, public InterfejsRysowania
{
private:
    std::array<Wektor<3>,12> punkty;
public:
    /*! \brief Konstruktor tworzy graniastoslup o podstawie szesciokata foremnego o zadanym promieniu i wysokosci
